...
const initialTargets: Target[] = [
  ...
  // Entry Tier (difficulty 1-2)
  {
    ...
    difficulty: 1,
    securityLevel: 1,
    rewards: { credits: 60, experience: 30, reputation: 2 },
    unlocked: false,
  },
  {
    id: 'target-7',
    name: 'Smart City Traffic Hub',
    type: 'government',
    difficulty: 1,
    securityLevel: 2,
    rewards: { credits: 80, experience: 40, reputation: 2 },
    unlocked: false,
  },
  {
    id: 'target-8',
    name: 'Crypto Mining Rig Cluster',
    type: 'individual',
    difficulty: 2,
    securityLevel: 2,
    rewards: { credits: 200, experience: 100, reputation: 5 },
    unlocked: false,
  },
  {
    id: 'target-9',
    name: 'Suburban Mesh Network',
    type: 'individual',
    difficulty: 2,
    securityLevel: 3,
    rewards: { credits: 250, experience: 120, reputation: 5 },
    unlocked: false,
  },
  // Mid Tier (difficulty 3-4)
  {
    id: 'target-10',
    name: 'Dark Net Marketplace',
    type: 'criminal',
    difficulty: 3,
    securityLevel: 4,
    rewards: { credits: 400, experience: 200, reputation: 10 },
    unlocked: false,
  },
  {
    id: 'target-11',
    ...
    difficulty: 3,
    securityLevel: 3,
    rewards: { credits: 350, experience: 180, reputation: 10 },
    unlocked: false,
  },
  {
    id: 'target-12',
    ...
    difficulty: 4,
    securityLevel: 5,
    rewards: { credits: 600, experience: 350, reputation: 15 },
    unlocked: false,
  },
  {
    id: 'target-13',
    name: 'Satellite ISP Backbone',
    type: 'corporation',
    difficulty: 4,
    securityLevel: 6,
    rewards: { credits: 1000, experience: 500, reputation: 25 },
    unlocked: false,
  },
  // High Tier (difficulty 5-6)
  {
    id: 'target-14',
    name: 'Military Drone Uplink',
    type: 'government',
    difficulty: 5,
    securityLevel: 7,
    rewards: { credits: 2500, experience: 1200, reputation: 60 },
    unlocked: false,
  },
  {
    id: 'target-15',
    name: 'Central Bank SWIFT Terminal',
    type: 'corporation',
    difficulty: 5,
    securityLevel: 8,
    rewards: { credits: 3000, experience: 1500, reputation: 70 },
    unlocked: false,
  },
  {
    id: 'target-16',
    name: 'AI Research Lab Core',
    type: 'corporation',
    difficulty: 6,
    securityLevel: 8,
    rewards: { credits: 5000, experience: 2500, reputation: 100 },
    unlocked: false,
  },
  {
    id: 'target-17',
    name: 'Defense Contractor Mainframe',
    type: 'corporation',
    difficulty: 6,
    securityLevel: 9,
    rewards: { credits: 6000, experience: 3000, reputation: 120 },
    unlocked: false,
  },
  // Elite Tier (difficulty 7-8)
  {
    id: 'target-18',
    name: 'Extraterrestrial Signal Array',
    type: 'government',
    difficulty: 7,
    securityLevel: 9,
    rewards: { credits: 10000, experience: 5000, reputation: 200 },
    unlocked: false,
  },
  {
    id: 'target-19',
    name: 'NSA Black Site Server',
    type: 'government',
    difficulty: 7,
    securityLevel: 10,
    rewards: { credits: 15000, experience: 7500, reputation: 300 },
    unlocked: false,
  },
  {
    id: 'target-20',
    name: 'Quantum Encryption Node',
    type: 'government',
    difficulty: 8,
    securityLevel: 10,
    rewards: { credits: 25000, experience: 10000, reputation: 500 },
    unlocked: false,
  },
];
